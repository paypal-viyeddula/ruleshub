...
Shape **`cartPayload`** per the current Cart API schema (intent, items, payee, experience context, etc.) in the [create cart reference](https://developer.paypal.com/store-sync/integrate.md).
